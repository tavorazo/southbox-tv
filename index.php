...
<header id="header" class="header">
	<menu type="context toolbar">
		...
		<div class="menu-search">
			...
			<button class="purple text-white">S</button>
		</div>
		<div class="menu-options purple text-right">
			<ul>
				<li><a href="#" class="border-white">¡Registrate ahora!</a></li>
				<li><a href="#"><img src="login"></a></li>
				<li><a href="#"><img src="settings"></a></li>	
			</ul>
		</div>
	</menu>
...
<footer class="footer" id="footer">
	...
	<div class="firma">Todos los derechos reservados a Southboxtv.</div>
</footer>
<!-- end footer section -->
